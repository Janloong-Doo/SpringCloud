...
import com.janloong.entity.dto.UserDTO;
import com.janloong.entity.project.UserProject;
...
public interface UserRepository extends JpaRepository<User, String>, JpaSpecificationExecutor<User> {
    ...
    //新实体类方式
    @Query(value = "select new com.janloong.entity.dto.UserDTO(u.name ,u.address ) from User u")
    UserDTO findTest2();
