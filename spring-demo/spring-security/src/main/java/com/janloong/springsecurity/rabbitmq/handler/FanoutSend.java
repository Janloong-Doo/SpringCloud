 ...
 **/
@Service
public class FanoutSend implements MsgSendHandler {
    ...
    public Object sendMsg(RabbitTemplate rabbitTemplate) {
        try {
            ...
            Thread.sleep(2000);
            String sendRoutingKey = FanoutQueueConfig.TOPIC_ROUTING_KEY;
            ...
            rabbitTemplate.convertAndSend(FanoutQueueConfig.TOPIC_EXCHANGE, sendRoutingKey, map);
            Thread.sleep(2000);
            System.out.println("send over");
            String sendRoutingKey2 = FanoutQueueConfig.TOPIC_ROUTING_KEY2;
            ...
            rabbitTemplate.convertAndSend(FanoutQueueConfig.TOPIC_EXCHANGE, sendRoutingKey2, map2);
            Thread.sleep(2000);
            System.out.println("send over1");

            String sendRoutingKey3 = FanoutQueueConfig.TOPIC_ROUTING_KEY3;
            ...
            rabbitTemplate.convertAndSend(FanoutQueueConfig.TOPIC_EXCHANGE, sendRoutingKey3, map3);
            Thread.sleep(2000);
            ...
            rabbitTemplate.convertAndSend(FanoutQueueConfig.TOPIC_EXCHANGE, sendRoutingKey4, map4);
            Thread.sleep(2000);
            System.out.println("send over3");

            String sendRoutingKey5 = "";
            ...
            rabbitTemplate.convertAndSend(FanoutQueueConfig.TOPIC_EXCHANGE, null, map5);
